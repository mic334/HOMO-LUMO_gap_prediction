...
def pred_Q9_diff_model():
    ...
    output_filecsv = [
    ("../data/processed/test/qm9_test.csv", "../data/finale_elaborato/qm9_pred_test.csv"),
    ("../data/processed/train/qm9_train.csv", "../data/finale_elaborato/qm9_pred_train.csv")
]
    ...
    #---------------build data_frame_for_analisys---------#
        ...
        parser_QM9.save_csv(df, save_name)
